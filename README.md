...
1. Clone the repository:
    ```bash
    git clone git@github.com:khalil-bouali/spring-boot-keycloak-integration.git
    ```
...
3. Create a new Real and name ut ```Kbouali``` or update the ```application.yml``` file and specify your Realm name
4. Create Roles
5. Create Users
